...
public class DBOperation{
	private DBChance database = null;
	public DBOperation(Context context){
		database = new DBChance(context);
	}
	...
	public List getByName(String queryName,int sort){
		...
		String sql="select * from chance where name like ? or number like ?";
		switch (sort) {
			case 0:
				sql = "select * from chance where name like ? or number like ?";
				break;
			case 1:
				sql = "select * from chance where name like ? or number like ? order by date asc";
				break;
			case 2:
				sql = "select * from chance where name like ? or number like ? order by cast(money as decimal(9,2)) asc";
		}
